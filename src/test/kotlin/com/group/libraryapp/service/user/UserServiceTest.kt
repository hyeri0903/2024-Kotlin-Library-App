...
class UserServiceTest @Autowired constructor(
    ...
    fun getUsersTest() {
        ...
        userRepository.saveAll(listOf(
                User("A", UserStatus.ACTIVE, 20),
                User("B", UserStatus.ACTIVE,null),
        ))
    ...
    fun updateUserNameTest() {
        // given
        val savedUser = userRepository.save(User("A", UserStatus.ACTIVE, null))
    ...
    fun deleteUserTest() {
        // given
        userRepository.save(User("A", UserStatus.ACTIVE, null))
